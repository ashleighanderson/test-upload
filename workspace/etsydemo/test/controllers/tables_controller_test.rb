...
class TablesControllerTest < ActionController::TestCase
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post :create, table: { Company: @table.Company, Industry: @table.Industry, Location: @table.Location, Name: @table.Name }
    end
  ...
  test "should update table" do
    patch :update, id: @table, table: { Company: @table.Company, Industry: @table.Industry, Location: @table.Location, Name: @table.Name }
    assert_redirected_to table_path(assigns(:table))
  end
